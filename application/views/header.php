...
<html lang="en">
  ...
  <body>
    ...
    <header class="navbar navbar-dark sticky-top topbar flex-md-nowrap py-2 shadow shadow-xl">
      <a class="navbar-brand col-sm-6 col-md-3 col-lg-2 me-0 fw-bold text-center p-2" href="<?= site_url("dashboard"); ?>">
      <span><img src="<?= base_url("assets/favicon.ico") ?>" width="28"></span> Klinik Terpadu</a>
